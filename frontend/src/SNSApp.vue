            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="hotels"
                        to="/hotelAccommodationProviders/hotels"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="transportation"
                        to="/transportationProviders/transportation"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '호텔', 
                description: 'Hotel을 관리하는 화면입니다.', 
                key: 'hotels', 
                route: '/hotelAccommodationProviders/hotels',
                ImageUrl: '',
            },
            { 
                title: '항공편', 
                description: 'Flight을 관리하는 화면입니다.', 
                key: 'flights', 
            ...
            { 
                title: '교통수단', 
                description: 'Transportation을 관리하는 화면입니다.', 
                key: 'transportation', 
                route: '/transportationProviders/transportation',
                ImageUrl: '',
            },
